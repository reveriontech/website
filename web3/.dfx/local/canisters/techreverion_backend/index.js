...
import { idlFactory } from './techreverion_backend.did.js';
export { idlFactory } from './techreverion_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_TECHREVERION_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./techreverion_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the techreverion_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./techreverion_backend.did.js")._SERVICE>}
 */
export const techreverion_backend = createActor(canisterId);
