...
import { idlFactory } from './techreverion_frontend.did.js';
export { idlFactory } from './techreverion_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_TECHREVERION_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./techreverion_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the techreverion_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./techreverion_frontend.did.js")._SERVICE>}
 */
export const techreverion_frontend = createActor(canisterId);
